...
#job2=$(sbatch --dependency=afterok:${job1##* } submitStep2_2013.sh)
#sbatch --dependency=afterok:${job2##* } submitStep3_2013.sh
sbatch --dependency=afterok:${job1##* } submitStep3_2013.sh

# Submit jobs for 2014 (sequential)
job1=$(sbatch submitStep1_2014.sh)
#job2=$(sbatch --dependency=afterok:${job1##* } submitStep2_2014.sh)
#sbatch --dependency=afterok:${job2##* } submitStep3_2014.sh
sbatch --dependency=afterok:${job1##* } submitStep3_2014.sh
