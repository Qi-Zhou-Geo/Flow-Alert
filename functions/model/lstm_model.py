...
class Ensemble_Trained_LSTM_Classifier:
    ...
    def load_trained_model(self, ML_name, station,
                           ...
                           repeat,
                           attention=False, print_model_summary=False):
        ...
        if attention is True:
            model = LSTM_Attention(feature_size=feature_size, device=self.device)
        else:
    ...
    def ensemble_models(self, num_repeat=5, attention=False, print_model_summary=False):
