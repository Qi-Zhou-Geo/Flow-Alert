...
<<<<<<< HEAD
    ...
    Args:
        ...
        params: str, format as
        repeate: float, 1, 2, 3, this parameter is designed for reduce uncentrity
...
<<<<<<< HEAD
def prepare_dataloader(feature_type, batch_size, seq_length, params, normalize, repeate=1):
=======
