...
select_start_time =  "2025-07-03T03:00:00"
select_end_time =  "2025-07-04T06:00:00"
...
for t in tqdm(np.arange(1, 1440*4+1)):
    ...
    for s, station in enumerate(station_list):
        ...
        features = (features - min_vals) / range_vals # normalize
